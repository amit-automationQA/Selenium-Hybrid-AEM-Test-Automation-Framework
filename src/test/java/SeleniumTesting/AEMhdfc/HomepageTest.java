...
public class HomepageTest extends BaseClass {
	...
	/*
	 * @Test(priority=2,retryAnalyzer = Analyzer.RetryAnalyzer.class) public void
	 * verifyTermPlanOnBanner() throws InterruptedException {
	 * hp.clickTermPlanBlock(); hp.verifyLink1(
	 * "https://www.hdfclife.com/term-insurance-plans/click-2-protect-life"); }
	 */
	...
	public void verifyschedulepopupblankSubmit() throws InterruptedException // verify submitting blank data in schedule
																				// a call popup
	{
		hp.clickScheduleACallButton().click();
	...
	/*
	 * @Test(priority=18, dependsOnMethods = {"verifyMouseIndicator" }) public void
	 * verifycalculatorWithValidData() throws InterruptedException {
	 * hp.scrollTillLetUsCalculate(); hp.clickLetsCalculateButton();
	 * hp.calculatorInputs("30", "50", "200000", "2000", "0", "graduate", "0");
	 * hp.clickCalculateButton2(); hp.verifyResultSection();
	 * hp.verifyC2PLProductResult(); js.executeScript("window.scrollBy(0,-800)");
	 * Thread.sleep(3000); hp.clickLetsCalculateButton(); hp.calculatorInputs("30",
	 * "50", "200000", "2000", "0", "graduate", "0"); hp.clickCalculateButton2();
	 * hp.verifyLearnMorebtn(
	 * "https://www.hdfclife.com/products/term-insurance-plans/click-2-protect-life"
	 * ); }
	...
	public void verifySanchayPlusBuyNowBtn() throws InterruptedException {
		...
		hp.verifyLinkOpenedInNewWindow(
				"https://onlineinsurance.hdfclife.com/buy-online-savings-plans/sanchayplus-savings-plan?source=NW_SANCHAYP_HP_BuyNow&agentcode=00399206&language=sanchp_EN",
	...
	public void verifyDisclaimer() throws InterruptedException {
		...
		Thread.sleep(3000);
		softAssertion.assertTrue(hp.disclaimerAccordionOpened().isDisplayed());// check if the accordion is open on page
																				// load
	...
	/*
	 * @Test(priority=27, dependsOnMethods= {"verifyGroupWebsitesLinks"}) public
	 * void verifyArticlesOnHomePage() throws InterruptedException {
	 * js.executeScript("window.scrollBy(0,-2000)"); cp.verifyArticles(); }
	 */
